...
import { Button } from '@/lib/plate/ui/button';
import {
  Tooltip,
  TooltipContent,
  TooltipTrigger,
} from '@/lib/plate/ui/tooltip';
      ...
      <TooltipTrigger asChild>
        <div
          ...
          onMouseDown={(e) => {
            ...
            if (!selectionNodes.some(([node]: [TElement]) => node.id === element.id)) {
          ...
          onMouseEnter={() => {
            ...
            // If current block is not in selection, use it as the starting point
            if (!selectedBlocks.some(([node]: [TElement]) => node.id === element.id)) {
