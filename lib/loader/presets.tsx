...
import {
  ...
  selectProvider, selectRegister, selectContentRenderer, selectValueRenderer,
  comboboxProvider, comboboxListRenderer, comboboxValueRenderer,
  comboboxChipsAnchor, comboboxContentAnchor,
...
export function createShadcnLoader(modules: ModuleMap): ComponentLoader {
  const loader = new ComponentLoader({
    ...
    wrappers: {
      ...
      "select-value": selectValueRenderer,
      "combobox": comboboxProvider,
      "combobox-chips": comboboxChipsAnchor,
      "combobox-content": comboboxContentAnchor,
      "combobox-list": comboboxListRenderer,
      "combobox-value": comboboxValueRenderer,
    },
    propTransforms: {
